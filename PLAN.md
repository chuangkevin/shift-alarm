...
- [x] 0.3.1 已部署至實機；應用程式與啟動選擇區雜湊驗證通過。
- [x] 部署後 Wi-Fi、90 度方向、11 筆使用者鬧鐘與班表 revision 保留。
- [x] 0.3.1 私有更新檔已發布，SHA-256 `833fd910a56053aa21f562a1a066c8603129a7d1bf224a61e17027a7d3444e38`。
- [x] 專案及 homelab-docs 透過既有 SSH 金鑰推送。
- [ ] 完整 OTA 驗證尚未完成。0.2.9 下載中止保留舊版；0.3.1 本次以 USB 部署，不將 USB 部署記為 OTA 成功。
