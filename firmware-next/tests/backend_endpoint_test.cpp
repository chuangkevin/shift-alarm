...
int main(){
  ...
  for(const char *s:{"http://127.0.0.1:8238","http://192.168.1.2:8238","http://100.126.226.79:0","http://100.126.226.79:65536","http://100.126.226.79:8238/path","http://100.126.226.79:8238@evil","http://100.126.226.79:08238"}) assert(!backendendpoint::parse(s,e));
}
