...
- 後端 0.1.5 與 GN100 Caddy 離線 fallback 已於 2026-09-15 部署。待驗證韌體為 0.3.12，實機仍是 0.3.8；五次舊版 OTA 嘗試均未完成，server chunk 策略無法修復裝置端讀取競態。0.3.12 先在第二台裝置以 USB bootstrap，不能直接改動目前裝置。
