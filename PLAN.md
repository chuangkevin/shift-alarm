...
- [x] 手機→ESP32 使用區網；ESP32→辨識後端固定原生 Tailscale。
- [x] 0.2.8 實圖經裝置/Tailscale 上傳 HTTP 200，36.851 秒，11 天上班日正確；健康檢查 1.704 秒。
- [x] 0.3.0 USB 更新後 Wi-Fi、90 度方向、11 筆使用者鬧鐘與班表 revision 保留。
- [x] 0.3.1 程式、工具及文件已整理；私有更新檔已發布，SHA-256 `833fd910a56053aa21f562a1a066c8603129a7d1bf224a61e17027a7d3444e38`。
- [x] 專案及 homelab-docs 透過既有 SSH 金鑰推送。
- [ ] 完整 OTA 驗證依使用者要求暫停。0.2.9 下載中止保留舊版；0.3.1 預檢健康檢查 503，未啟動安裝。裝置留在 0.3.0，不將發布或編譯成功記為安裝成功。
